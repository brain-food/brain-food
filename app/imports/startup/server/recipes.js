...
const recipeSeeds = [
  {
    ...
    username: "clintmor",
    shortdescription: "Cooking a perfect steak is easier than it seems. All you need is a sturdy pan, salt, pepper, olive oil, and a solid cooking technique. For this pan-seared method, start by letting the steak sit at room temperature for at least 30 minutes so it comes up to room temp and will cook evenly. Then, just sprinkle on salt and pepper, rub on some oil, and get your pan really hot. Lay the steak in the pan and don’t mess with it until it’s ready to turn. In about 8 minutes, you’ll have a perfectly cooked steak to serve with a potato gratin.".split(" ").splice(0, 20).join(" ") + "...",
  },
  {
    ...
    username: "clintmor",
    shortdescription: "Sometimes you're in a rush and you need a little snack; or you just don't like cooking. A microwaved sweet potato can be surprisingly filling, and is actually not too detrimental to your health. Don't eat it exclusively though.".split(" ").splice(0, 20).join(" ") + "...",
  },
];
